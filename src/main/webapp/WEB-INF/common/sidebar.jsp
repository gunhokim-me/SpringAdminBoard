    ...
    pageEncoding="UTF-8"%>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="/" class="brand-link"> <img src="${cp }/resources/images/line.png" class="brand-image img-circle elevation-3" style="opacity: .8"> <span
				class="brand-text font-weight-light">사용자 관리</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="/user/profile?userid=${S_USER.userid}" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<div class="row">
							<a class="col-md-8" href="/user/userDetail?userid=${S_USER.userid}" class="d-block">${S_USER.userid }(${S_USER.alias })</a>
						</div>
					</div>
				</div>
