				...
				<section class="content">
					<div class="card">
						<div class="card-header with-border">
							<button type="button" class="btn btn-primary" onclick="location.href='memberRegist.jsp';">회원등록</button>
								...
								<ul class="pagination justify-content-center m-0">
									...
									<c:forEach begin="1" end="${pagination }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a class="page-link" href="${cp}/paging.do?page=${i }&pageSize=${pageVo.getPageSize()}"><span>${i }</span></a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
